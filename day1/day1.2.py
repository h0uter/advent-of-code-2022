...
if __name__ == "__main__":
    ...
    our_elf_totals = np.array(our_elf_totals)
    max_idxs = (-our_elf_totals).argsort()[:3]
    print(f"The max idxs are {max_idxs}")
    print(f"the highest calories are {our_elf_totals[max_idxs]}")
    print(f"total calories = {sum(our_elf_totals[max_idxs])}")
